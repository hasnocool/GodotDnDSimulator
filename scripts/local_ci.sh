...
godot --headless --path "$ROOT_DIR/apps/godot-client" --script res://tests/tactical_hud_focus_tests.gd
godot --headless --path "$ROOT_DIR/apps/godot-client" --script res://tests/tactical_grid_integer_tests.gd
